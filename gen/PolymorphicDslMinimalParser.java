...
public class PolymorphicDslMinimalParser extends Parser {
	...
	public static class PolymorphicDslAllRulesContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PolymorphicDslMinimalParserVisitor ) return ((PolymorphicDslMinimalParserVisitor<? extends T>)visitor).visitPolymorphicDslAllRules(this);
	...
	public static class MinimalContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PolymorphicDslMinimalParserVisitor ) return ((PolymorphicDslMinimalParserVisitor<? extends T>)visitor).visitMinimal(this);
			else return visitor.visitChildren(this);
		}
	}
