...
public class PolymorphicDslRegistryParser extends Parser {
	...
	public static class PolymorphicDslAllRulesContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PolymorphicDslRegistryParserVisitor ) return ((PolymorphicDslRegistryParserVisitor<? extends T>)visitor).visitPolymorphicDslAllRules(this);
	...
	public static class Mathematical_expressionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PolymorphicDslRegistryParserVisitor ) return ((PolymorphicDslRegistryParserVisitor<? extends T>)visitor).visitMathematical_expression(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class HelloWorldContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PolymorphicDslRegistryParserVisitor ) return ((PolymorphicDslRegistryParserVisitor<? extends T>)visitor).visitHelloWorld(this);
			else return visitor.visitChildren(this);
		}
	}
