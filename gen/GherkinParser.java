...
public class GherkinParser extends Parser {
	...
	public static class GherkinDocumentContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GherkinParserVisitor ) return ((GherkinParserVisitor<? extends T>)visitor).visitGherkinDocument(this);
	...
	public static class RuleBlockContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GherkinParserVisitor ) return ((GherkinParserVisitor<? extends T>)visitor).visitRuleBlock(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StepBodyContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GherkinParserVisitor ) return ((GherkinParserVisitor<? extends T>)visitor).visitStepBody(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExamplesBodyContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GherkinParserVisitor ) return ((GherkinParserVisitor<? extends T>)visitor).visitExamplesBody(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StartingStepContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GherkinParserVisitor ) return ((GherkinParserVisitor<? extends T>)visitor).visitStartingStep(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AnyStepContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GherkinParserVisitor ) return ((GherkinParserVisitor<? extends T>)visitor).visitAnyStep(this);
			else return visitor.visitChildren(this);
		}
	}
