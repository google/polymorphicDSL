...
format that no one has natively supported yet. PDSL natively supports gherkin. See link:quickstart.adoc[the quickstart] if you think gherkin can meet your use case.

== A custom grammar

Suppose you made a website. Certain pages can only be accessed by priviledged user.
But to complicate matters it is your job to make sure that it is possible to
...
----
include::../images/graphviz/website.dot[]
----
...
----
include::../../examples/quickstart/src/test/antlr4/com/example/DotNavigationLexer.g4[]
----

After that we make a parser (which specifies how we're allowed to combine the words).

----
include::../../examples/quickstart/src/test/antlr4/com/example/DotNavigationParser.g4[]
----
...
[source,Java]
----
include::../../examples/quickstart/src/test/java/com/pdsl/custom/CustomDotNavigationListener.java[]
----
...
build in feature of PDSL: the _FileDelimitedTestSpecificationFactory_.
...
provides out of the box, see link:../specification_factories.adoc[Specification Factories].
...
To lear more about Test Case Factories in general see link:../test_case_factories.adoc[Test Case Factories].
...
[source,Java]
----
include::../../examples/quickstart/src/test/java/com/pdsl/custom/CustomGrammarTest.java[]
----
