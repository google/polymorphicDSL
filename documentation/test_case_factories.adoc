...
cases to turn a link:specification_factories.adoc[specification] into, as well
...
These factories will always run their parent phrases before each child phrase.
...
This serves as yet another example of how to use the interpreter patter to make
