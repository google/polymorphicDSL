...
BDD tools like Cucumber are admirable, but they weren't designed to make tests scalable and they tend to implode when used for the Interpreter Pattern. To better understand this, see link:why_not_cucumber.adoc[why not just use cucumber?]
