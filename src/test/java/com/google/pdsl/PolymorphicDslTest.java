...
import static com.google.pdsl.specifications.LineDelimitedTestSpecificationFactory.ErrorListenerStrategy;


import static com.google.common.truth.Truth.assertThat;
import static org.junit.Assert.fail;

import com.google.pdsl.executors.DefaultPolymorphicDslTestExecutor;
...
public class PolymorphicDslTest {
    ...
    public void validGrammarWalkThroughRegistryAllStepsInContext_shouldSucceed()
    {
        ...
        TestSpecificationFactory provider =
                new LineDelimitedTestSpecificationFactory<PolymorphicDslRegistryParser, RegistryLexer>(PolymorphicDslRegistryParser.class, RegistryLexer.class, ErrorListenerStrategy.GRAMMAR);
    ...
    public void validGrammarWalkThroughContext_notAllStepsShouldRun()
    {
        ...
        // Arrange
        TestSpecificationFactory provider =
                new LineDelimitedTestSpecificationFactory<PolymorphicDslBetaParser, BetaLexer>(PolymorphicDslBetaParser.class, BetaLexer.class, ErrorListenerStrategy.SUBGRAMMAR);
        List<String> dslFiles = new LinkedList<>();
    ...
    public void testWithEmptyFile_illegalArgument() {
        // Arrange
        TestSpecificationFactory provider =
                new LineDelimitedTestSpecificationFactory<PolymorphicDslBetaParser, BetaLexer>(PolymorphicDslBetaParser.class, BetaLexer.class, ErrorListenerStrategy.GRAMMAR);
        List<String> dslFiles = new LinkedList<>();
