...
public class OmegaParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "OmegaParser.g4"; }
	...
	public OmegaParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class AllInputsContext extends ParserRuleContext {
		public List<TerminalNode> ALL_INPUTS() { return getTokens(OmegaParser.ALL_INPUTS); }
		public TerminalNode ALL_INPUTS(int i) {
			return getToken(OmegaParser.ALL_INPUTS, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OmegaParserListener ) ((OmegaParserListener)listener).enterAllInputs(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OmegaParserListener ) ((OmegaParserListener)listener).exitAllInputs(this);
		}
	}
