...
//////////////////////////////////////////////////////////////////////////
AF_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'af' LINE_END -> mode(AF) ; 
AM_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'am' LINE_END -> mode(AM) ;
AN_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'an' LINE_END -> mode(AN) ;
AR_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ar' LINE_END -> mode(AR) ;
AST_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ast' LINE_END -> mode(AST) ;
AZ_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'az' LINE_END -> mode(AZ) ;
BG_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'bg' LINE_END -> mode(BG) ;
BM_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'bm' LINE_END -> mode(BM) ;
BS_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'bs' LINE_END -> mode(BS) ;
CA_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ca' LINE_END -> mode(CA) ;
CS_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'cs' LINE_END -> mode(CS) ;
CY_GB_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'cy-GB' LINE_END -> mode(CY_GB) ;
DA_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'da' LINE_END -> mode(DA) ;
DE_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'de' LINE_END -> mode(DE) ;
EL_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'el' LINE_END -> mode(EL) ;
EM_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'em' LINE_END -> mode(EM) ;
EN_SCOUSE_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'en-Scouse' LINE_END -> mode(EN_SCOUSE) ;
EN_AU_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'en-au' LINE_END -> mode(EN_AU) ;
EN_LOL_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'en-lol' LINE_END -> mode(EN_LOL) ;
EN_OLD_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'en-old' LINE_END -> mode(EN_OLD) ;
EN_PIRATE_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'en-pirate' LINE_END -> mode(EN_PIRATE) ;
EO_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'eo' LINE_END -> mode(EO) ;
ES_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'es' LINE_END -> mode(ES) ;
ET_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'et' LINE_END -> mode(ET) ;
FA_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'fa' LINE_END -> mode(FA) ;
FI_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'fi' LINE_END -> mode(FI) ;
FR_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'fr' WS* LINE_END -> mode(FR) ;
GA_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ga' LINE_END -> mode(GA) ;
GJ_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'gj' LINE_END -> mode(GJ) ;
GL_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'gl' LINE_END -> mode(GL) ;
HE_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'he' LINE_END -> mode(HE) ;
HI_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'hi' LINE_END -> mode(HI) ;
HR_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'hr' LINE_END -> mode(HR) ;
HT_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ht' LINE_END -> mode(HT) ;
HU_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'hu' LINE_END -> mode(HU) ;
ID_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'id' LINE_END -> mode(ID) ;
IS_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'is' LINE_END -> mode(IS) ;
IT_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'it' LINE_END -> mode(IT) ;
JA_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ja' LINE_END -> mode(JA) ;
JV_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'jv' LINE_END -> mode(JV) ;
KA_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ka' LINE_END -> mode(KA) ;
KN_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'kn' LINE_END -> mode(KN) ;
KO_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ko' LINE_END -> mode(KO) ;
LT_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'lt' LINE_END -> mode(LT) ;
LU_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'lu' LINE_END -> mode(LU) ;
LV_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'lv' LINE_END -> mode(LV) ;
MK_CYRL_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'mk-Cyrl' LINE_END -> mode(MK_CYRL) ;
MK_LATN_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'mk-Latn' LINE_END -> mode(MK_LATN) ;
MN_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'mn' LINE_END -> mode(MN) ;
NE_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ne' LINE_END -> mode(NE) ;
NL_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'nl' LINE_END -> mode(NL) ;
NO_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'no' WS* LINE_END -> mode(NO) ;
PA_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'pa' LINE_END -> mode(PA) ;
PL_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'pl' LINE_END -> mode(PL) ;
PT_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'pt' LINE_END -> mode(PT) ;
RO_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ro' LINE_END -> mode(RO) ;
RU_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ru' LINE_END -> mode(RU) ;
SK_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'sk' LINE_END -> mode(SK) ;
SL_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'sl' LINE_END -> mode(SL) ;
SR_CYRL_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'sr-Cyrl' LINE_END -> mode(SR_CYRL) ;
SR_LATN_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'sr-Latn' LINE_END -> mode(SR_LATN) ;
SV_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'sv' LINE_END -> mode(SV) ;
TA_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ta' LINE_END -> mode(TA) ;
TH_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'th' LINE_END -> mode(TH) ;
TE_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'te' LINE_END -> mode(TE) ;
TLH_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'tlh' LINE_END -> mode(TLH) ;
TR_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'tr' LINE_END -> mode(TR) ;
TT_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'tt' LINE_END -> mode(TT) ;
UK_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'uk' LINE_END -> mode(UK) ;
UR_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'ur' LINE_END -> mode(UR) ;
UZ_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'uz' LINE_END -> mode(UZ) ;
VI_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'vi' LINE_END -> mode(VI) ;
ZH_CN_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'zh-CN' LINE_END -> mode(ZH_CN) ;
ZH_TW_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'zh-TW' LINE_END -> mode(ZH_TW) ;
MR_LANGUAGE_HEADER : LANGUAGE_KEYWORD 'mr' LINE_END -> mode(MR) ;
//////////////////////////////////////////////////////////////////////////
...
mode AF;
 ...
 //    AF_STARTING_STEP : WS* AF_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    AF_ALTERNATIVE_STEP : WS* AF_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode AM;
 ...
 //    AM_STARTING_STEP : WS* AM_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    AM_ALTERNATIVE_STEP : WS* AM_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode AN;
 ...
 //    AN_STARTING_STEP : WS* AN_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    AN_ALTERNATIVE_STEP : WS* AN_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode AR;
 ...
 //    AR_STARTING_STEP : WS* AR_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    AR_ALTERNATIVE_STEP : WS* AR_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode AST;
 ...
 //    AST_STARTING_STEP : WS* AST_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    AST_ALTERNATIVE_STEP : WS* AST_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode AZ;
 ...
 //    AZ_STARTING_STEP : WS* AZ_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    AZ_ALTERNATIVE_STEP : WS* AZ_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode BG;
 ...
 //    BG_STARTING_STEP : WS* BG_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    BG_ALTERNATIVE_STEP : WS* BG_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode BM;
 ...
 //    BM_STARTING_STEP : WS* BM_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    BM_ALTERNATIVE_STEP : WS* BM_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode BS;
 ...
 //    BS_STARTING_STEP : WS* BS_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    BS_ALTERNATIVE_STEP : WS* BS_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode CA;
 ...
 //    CA_STARTING_STEP : WS* CA_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    CA_ALTERNATIVE_STEP : WS* CA_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode CS;
 ...
 //    CS_STARTING_STEP : WS* CS_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    CS_ALTERNATIVE_STEP : WS* CS_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode CY_GB;
 ...
 //    CY_GB_STARTING_STEP : WS* CY_GB_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    CY_GB_ALTERNATIVE_STEP : WS* CY_GB_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode DA;
 ...
 //    DA_STARTING_STEP : WS* DA_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    DA_ALTERNATIVE_STEP : WS* DA_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode DE;
 ...
 //    DE_STARTING_STEP : WS* DE_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    DE_ALTERNATIVE_STEP : WS* DE_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EL;
 ...
 //    EL_STARTING_STEP : WS* EL_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EL_ALTERNATIVE_STEP : WS* EL_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EM;
 ...
 //    EM_STARTING_STEP : WS* EM_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EM_ALTERNATIVE_STEP : WS* EM_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EN;
 ...
 //    EN_STARTING_STEP : WS* EN_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EN_ALTERNATIVE_STEP : WS* EN_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EN_SCOUSE;
 ...
 //    EN_SCOUSE_STARTING_STEP : WS* EN_SCOUSE_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EN_SCOUSE_ALTERNATIVE_STEP : WS* EN_SCOUSE_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EN_AU;
 ...
 //    EN_AU_STARTING_STEP : WS* EN_AU_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EN_AU_ALTERNATIVE_STEP : WS* EN_AU_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EN_LOL;
 ...
 //    EN_LOL_STARTING_STEP : WS* EN_LOL_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EN_LOL_ALTERNATIVE_STEP : WS* EN_LOL_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EN_OLD;
 ...
 //    EN_OLD_STARTING_STEP : WS* EN_OLD_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EN_OLD_ALTERNATIVE_STEP : WS* EN_OLD_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EN_PIRATE;
 ...
 //    EN_PIRATE_STARTING_STEP : WS* EN_PIRATE_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EN_PIRATE_ALTERNATIVE_STEP : WS* EN_PIRATE_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode EO;
 ...
 //    EO_STARTING_STEP : WS* EO_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    EO_ALTERNATIVE_STEP : WS* EO_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode ES;
 ...
 //    ES_STARTING_STEP : WS* ES_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    ES_ALTERNATIVE_STEP : WS* ES_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode ET;
 ...
 //    ET_STARTING_STEP : WS* ET_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    ET_ALTERNATIVE_STEP : WS* ET_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode FA;
 ...
 //    FA_STARTING_STEP : WS* FA_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    FA_ALTERNATIVE_STEP : WS* FA_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode FI;
 ...
 //    FI_STARTING_STEP : WS* FI_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    FI_ALTERNATIVE_STEP : WS* FI_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode FR;
 ...
 //    FR_STARTING_STEP : WS* FR_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    FR_ALTERNATIVE_STEP : WS* FR_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode GA;
 ...
 //    GA_STARTING_STEP : WS* GA_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    GA_ALTERNATIVE_STEP : WS* GA_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode GJ;
 ...
 //    GJ_STARTING_STEP : WS* GJ_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    GJ_ALTERNATIVE_STEP : WS* GJ_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode GL;
 ...
 //    GL_STARTING_STEP : WS* GL_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    GL_ALTERNATIVE_STEP : WS* GL_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode HE;
 ...
 //    HE_STARTING_STEP : WS* HE_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    HE_ALTERNATIVE_STEP : WS* HE_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode HI;
 ...
 //    HI_STARTING_STEP : WS* HI_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    HI_ALTERNATIVE_STEP : WS* HI_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode HR;
 ...
 //    HR_STARTING_STEP : WS* HR_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    HR_ALTERNATIVE_STEP : WS* HR_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode HT;
 ...
 //    HT_STARTING_STEP : WS* HT_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    HT_ALTERNATIVE_STEP : WS* HT_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode HU;
 ...
 //    HU_STARTING_STEP : WS* HU_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    HU_ALTERNATIVE_STEP : WS* HU_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode ID;
 ...
 //    ID_STARTING_STEP : WS* ID_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    ID_ALTERNATIVE_STEP : WS* ID_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode IS;
 ...
 //    IS_STARTING_STEP : WS* IS_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    IS_ALTERNATIVE_STEP : WS* IS_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode IT;
 ...
 //    IT_STARTING_STEP : WS* IT_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    IT_ALTERNATIVE_STEP : WS* IT_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode JA;
 ...
 //    JA_STARTING_STEP : WS* JA_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    JA_ALTERNATIVE_STEP : WS* JA_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode JV;
 ...
 //    JV_STARTING_STEP : WS* JV_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    JV_ALTERNATIVE_STEP : WS* JV_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode KA;
 ...
 //    KA_STARTING_STEP : WS* KA_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    KA_ALTERNATIVE_STEP : WS* KA_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode KN;
 ...
 //    KN_STARTING_STEP : WS* KN_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    KN_ALTERNATIVE_STEP : WS* KN_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode KO;
 ...
 //    KO_STARTING_STEP : WS* KO_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    KO_ALTERNATIVE_STEP : WS* KO_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode LT;
 ...
 //    LT_STARTING_STEP : WS* LT_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    LT_ALTERNATIVE_STEP : WS* LT_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode LU;
 ...
 //    LU_STARTING_STEP : WS* LU_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    LU_ALTERNATIVE_STEP : WS* LU_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode LV;
 ...
 //    LV_STARTING_STEP : WS* LV_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    LV_ALTERNATIVE_STEP : WS* LV_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode MK_CYRL;
 ...
 //    MK_CYRL_STARTING_STEP : WS* MK_CYRL_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    MK_CYRL_ALTERNATIVE_STEP : WS* MK_CYRL_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode MK_LATN;
 ...
 //    MK_LATN_STARTING_STEP : WS* MK_LATN_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    MK_LATN_ALTERNATIVE_STEP : WS* MK_LATN_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode MN;
 ...
 //    MN_STARTING_STEP : WS* MN_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    MN_ALTERNATIVE_STEP : WS* MN_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode NE;
 ...
 //    NE_STARTING_STEP : WS* NE_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    NE_ALTERNATIVE_STEP : WS* NE_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode NL;
 ...
 //    NL_STARTING_STEP : WS* NL_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    NL_ALTERNATIVE_STEP : WS* NL_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode NO;
 ...
 //    NO_STARTING_STEP : WS* NO_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    NO_ALTERNATIVE_STEP : WS* NO_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode PA;
 ...
 //    PA_STARTING_STEP : WS* PA_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    PA_ALTERNATIVE_STEP : WS* PA_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode PL;
 ...
 //    PL_STARTING_STEP : WS* PL_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    PL_ALTERNATIVE_STEP : WS* PL_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode PT;
 ...
 //    PT_STARTING_STEP : WS* PT_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    PT_ALTERNATIVE_STEP : WS* PT_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode RO;
 ...
 //    RO_STARTING_STEP : WS* RO_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    RO_ALTERNATIVE_STEP : WS* RO_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode RU;
 ...
 //    RU_STARTING_STEP : WS* RU_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    RU_ALTERNATIVE_STEP : WS* RU_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode SK;
 ...
 //    SK_STARTING_STEP : WS* SK_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    SK_ALTERNATIVE_STEP : WS* SK_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode SL;
 ...
 //    SL_STARTING_STEP : WS* SL_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    SL_ALTERNATIVE_STEP : WS* SL_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode SR_CYRL;
 ...
 //    SR_CYRL_STARTING_STEP : WS* SR_CYRL_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    SR_CYRL_ALTERNATIVE_STEP : WS* SR_CYRL_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode SR_LATN;
 ...
 //    SR_LATN_STARTING_STEP : WS* SR_LATN_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    SR_LATN_ALTERNATIVE_STEP : WS* SR_LATN_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode SV;
 ...
 //    SV_STARTING_STEP : WS* SV_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    SV_ALTERNATIVE_STEP : WS* SV_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode TA;
 ...
 //    TA_STARTING_STEP : WS* TA_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    TA_ALTERNATIVE_STEP : WS* TA_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode TH;
 ...
 //    TH_STARTING_STEP : WS* TH_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    TH_ALTERNATIVE_STEP : WS* TH_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode TE;
 ...
 //    TE_STARTING_STEP : WS* TE_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    TE_ALTERNATIVE_STEP : WS* TE_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode TLH;
 ...
 //    TLH_STARTING_STEP : WS* TLH_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    TLH_ALTERNATIVE_STEP : WS* TLH_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode TR;
 ...
 //    TR_STARTING_STEP : WS* TR_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    TR_ALTERNATIVE_STEP : WS* TR_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode TT;
 ...
 //    TT_STARTING_STEP : WS* TT_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    TT_ALTERNATIVE_STEP : WS* TT_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode UK;
 ...
 //    UK_STARTING_STEP : WS* UK_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    UK_ALTERNATIVE_STEP : WS* UK_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode UR;
 ...
 //    UR_STARTING_STEP : WS* UR_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    UR_ALTERNATIVE_STEP : WS* UR_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode UZ;
 ...
 //    UZ_STARTING_STEP : WS* UZ_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    UZ_ALTERNATIVE_STEP : WS* UZ_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode VI;
 ...
 //    VI_STARTING_STEP : WS* VI_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    VI_ALTERNATIVE_STEP : WS* VI_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode ZH_CN;
 ...
 //    ZH_CN_STARTING_STEP : WS* ZH_CN_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    ZH_CN_ALTERNATIVE_STEP : WS* ZH_CN_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode ZH_TW;
 ...
 //    ZH_TW_STARTING_STEP : WS* ZH_TW_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    ZH_TW_ALTERNATIVE_STEP : WS* ZH_TW_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
...
mode MR;
 ...
 //    MR_STARTING_STEP : WS* MR_STARTING_STEP_KEYWORD ~[\r\n]+ LINE_END -> type(STARTING_STEP) ;

 //    MR_ALTERNATIVE_STEP : WS* MR_ALTERNATIVE_STEP_KEYWORD  ~[\r\n]+ LINE_END -> type(ALTERNATIVE_STEP);
