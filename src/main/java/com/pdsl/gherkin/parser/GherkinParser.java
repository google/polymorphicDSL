...
public class GherkinParser extends Parser {
    ...
    public static class GherkinDocumentContext extends ParserRuleContext {
        ...
        public TerminalNode LANGUAGE_HEADER() {
            return getToken(GherkinParser.LANGUAGE_HEADER, 0);
        }

        public List<TerminalNode> COMMENT() {
            return getTokens(GherkinParser.COMMENT);
        }
        ...
        public int getRuleIndex() {
            return RULE_gherkinDocument;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinParserListener)
                ((GherkinParserListener) listener).enterGherkinDocument(this);
        }
    ...
    public static class FeatureContext extends ParserRuleContext {
        ...
        public TerminalNode FEATURE_TITLE() {
            return getToken(GherkinParser.FEATURE_TITLE, 0);
        }

        public List<TerminalNode> TAGS() {
            return getTokens(GherkinParser.TAGS);
        }
        ...
        public List<TerminalNode> LONG_DESCRIPTION() {
            return getTokens(GherkinParser.LONG_DESCRIPTION);
        }
    ...
    public static class RuleBlockContext extends ParserRuleContext {
        ...
        public TerminalNode RULE_TITLE() {
            return getToken(GherkinParser.RULE_TITLE, 0);
        }
    ...
    public static class BackgroundContext extends ParserRuleContext {
        ...
        public TerminalNode BACKGROUND_TITLE() {
            return getToken(GherkinParser.BACKGROUND_TITLE, 0);
        }
    ...
    public static class ScenarioContext extends ParserRuleContext {
        ...
        public TerminalNode SCENARIO_TITLE() {
            return getToken(GherkinParser.SCENARIO_TITLE, 0);
        }

        public TerminalNode SCENARIO_OUTLINE_TITLE() {
            return getToken(GherkinParser.SCENARIO_OUTLINE_TITLE, 0);
        }
    ...
    public static class ExamplesBodyContext extends ParserRuleContext {
        ...
        public TerminalNode EXAMPLES_TITLE() {
            return getToken(GherkinParser.EXAMPLES_TITLE, 0);
        }
        ...
        public List<TerminalNode> DATA_ROW() {
            return getTokens(GherkinParser.DATA_ROW);
        }
    ...
    public static class StartingStepContext extends ParserRuleContext {
        ...
        public TerminalNode GIVEN_STEP() {
            return getToken(GherkinParser.GIVEN_STEP, 0);
        }

        public TerminalNode WHEN_STEP() {
            return getToken(GherkinParser.WHEN_STEP, 0);
        }

        public TerminalNode THEN_STEP() {
            return getToken(GherkinParser.THEN_STEP, 0);
        }

        public TerminalNode WILD_STEP() {
            return getToken(GherkinParser.WILD_STEP, 0);
        }

        public TerminalNode DOCSTRING() {
            return getToken(GherkinParser.DOCSTRING, 0);
        }
    ...
    public static class AnyStepContext extends ParserRuleContext {
        ...
        public TerminalNode AND_STEP() {
            return getToken(GherkinParser.AND_STEP, 0);
        }

        public TerminalNode BUT_STEP() {
            return getToken(GherkinParser.BUT_STEP, 0);
        }
