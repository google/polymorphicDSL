 ...
 * PdslJUnit4ConfigurableRunner}.
 *
 * If a <b>resourceRoot</b> is specified it will be prepended to all <em>includes</em> and <em>excludes</em> in every underlying
 * {@link:com.pdsl.runners.PdslTest @PdslTest}.
 *
