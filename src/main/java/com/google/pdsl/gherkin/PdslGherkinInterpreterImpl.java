...
public class PdslGherkinInterpreterImpl implements PdslGherkinInterpreter {
    ...
    public Optional<GherkinFeature> interpretGherkinFile(String filepath, PdslGherkinListener listener) throws IOException {
        com.google.pdsl.gherkin.GherkinLexer lexer = new com.google.pdsl.gherkin.GherkinLexer(CharStreams.fromFileName(filepath));
        CommonTokenStream tokens = new CommonTokenStream(lexer);
        com.google.pdsl.gherkin.GherkinParser parser = new com.google.pdsl.gherkin.GherkinParser(tokens);
    ...
    public Optional<GherkinFeature> interpretGherkinFileStrictly(InputStream featureFileContent, String featurePathOrId) throws IOException {
        com.google.pdsl.gherkin.GherkinLexer lexer = new com.google.pdsl.gherkin.GherkinLexer(CharStreams.fromStream(featureFileContent));
        CommonTokenStream tokens = new CommonTokenStream(lexer);
        com.google.pdsl.gherkin.GherkinParser parser = new com.google.pdsl.gherkin.GherkinParser(tokens);
        parser.setBuildParseTree(true); // tell ANTLR to build a parse tree
        ParseTree tree = parser.gherkinDocument();
